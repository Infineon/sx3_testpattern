...
// Mode selection
//	Uncomment to select between Camera Interface and SlaveFIFO Interface

// `define CAMERA_INTERFACE
`define SLFIFO_INTERFACE

// Note :
//		To be used only in the SlFIFO Interface mode
//		To enable audio only mode uncomment the below line
// `define SLFIFO_INTERFACE_AUD
