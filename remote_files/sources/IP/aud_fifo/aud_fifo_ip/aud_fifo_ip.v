...
`timescale 1 ns / 1 ps
module aud_fifo_ip (Data, Clock, WrEn, RdEn, Reset, Q, Empty, Full, 
    ...
    DP16KD pdp_ram_0_0_3 (.DIA17(scuba_vlo), .DIA16(scuba_vlo), .DIA15(scuba_vlo), 
        ...
        .DOB4(), .DOB3(Q[3]), .DOB2(Q[2]), .DOB1(Q[1]), .DOB0(Q[0]))
             /* synthesis MEM_LPC_FILE="aud_fifo_ip.lpc" */
    ...
    FD1P3DX FF_14 (.D(ircount_0), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_0))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_13 (.D(ircount_1), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_1))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_12 (.D(ircount_2), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_2))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_11 (.D(ircount_3), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_3))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_10 (.D(ircount_4), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_4))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_9 (.D(ircount_5), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_5))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_8 (.D(ircount_6), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_6))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_7 (.D(ircount_7), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_7))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_6 (.D(ircount_8), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_8))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_5 (.D(ircount_9), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_9))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_4 (.D(ircount_10), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_10))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_3 (.D(ircount_11), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_11))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_2 (.D(ircount_12), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_12))
             /* synthesis GSR="ENABLED" */;
    ...
    CCU2C ae_cmp_0 (.A0(fcnt_en_inv_inv), .A1(cnt_con_inv), .B0(fcount_0), 
    ...
    CCU2C ae_cmp_1 (.A0(scuba_vlo), .A1(scuba_vlo), .B0(fcount_2), .B1(fcount_3), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co0_5), .S0(), .S1(), .COUT(co1_5));

    defparam ae_cmp_2.INJECT1_1 = "NO" ;
    defparam ae_cmp_2.INJECT1_0 = "NO" ;
    defparam ae_cmp_2.INIT1 =  16'h99AA ;
    defparam ae_cmp_2.INIT0 =  16'h99AA ;
    CCU2C ae_cmp_2 (.A0(scuba_vhi), .A1(scuba_vhi), .B0(fcount_4), .B1(fcount_5), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co1_5), .S0(), .S1(), .COUT(co2_5));

    defparam ae_cmp_3.INJECT1_1 = "NO" ;
    defparam ae_cmp_3.INJECT1_0 = "NO" ;
    defparam ae_cmp_3.INIT1 =  16'h99AA ;
    defparam ae_cmp_3.INIT0 =  16'h99AA ;
    CCU2C ae_cmp_3 (.A0(scuba_vlo), .A1(scuba_vlo), .B0(fcount_6), .B1(fcount_7), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co2_5), .S0(), .S1(), .COUT(co3_5));

    defparam ae_cmp_4.INJECT1_1 = "NO" ;
    defparam ae_cmp_4.INJECT1_0 = "NO" ;
    defparam ae_cmp_4.INIT1 =  16'h99AA ;
    defparam ae_cmp_4.INIT0 =  16'h99AA ;
    CCU2C ae_cmp_4 (.A0(scuba_vlo), .A1(scuba_vlo), .B0(fcount_8), .B1(fcount_9), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co3_5), .S0(), .S1(), .COUT(co4_5));

    defparam ae_cmp_5.INJECT1_1 = "NO" ;
    defparam ae_cmp_5.INJECT1_0 = "NO" ;
    defparam ae_cmp_5.INIT1 =  16'h99AA ;
    defparam ae_cmp_5.INIT0 =  16'h99AA ;
    CCU2C ae_cmp_5 (.A0(scuba_vlo), .A1(scuba_vlo), .B0(fcount_10), .B1(fcount_11), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co4_5), .S0(), .S1(), .COUT(co5_5));

    defparam ae_cmp_6.INJECT1_1 = "NO" ;
    defparam ae_cmp_6.INJECT1_0 = "NO" ;
    defparam ae_cmp_6.INIT1 =  16'h99AA ;
    defparam ae_cmp_6.INIT0 =  16'h99AA ;
    CCU2C ae_cmp_6 (.A0(scuba_vlo), .A1(scuba_vlo), .B0(fcount_12), .B1(scuba_vlo), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co5_5), .S0(), .S1(), .COUT(ae_d_c));
    ...
    CCU2C af_cmp_1 (.A0(fcount_2), .A1(fcount_3), .B0(cnt_con), .B1(cnt_con_inv), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C af_cmp_2 (.A0(fcount_4), .A1(fcount_5), .B0(scuba_vhi), .B1(scuba_vlo), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C af_cmp_3 (.A0(fcount_6), .A1(fcount_7), .B0(scuba_vhi), .B1(scuba_vhi), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C af_cmp_4 (.A0(fcount_8), .A1(fcount_9), .B0(scuba_vlo), .B1(scuba_vhi), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co3_6), .S0(), .S1(), .COUT(co4_6));
    ...
    CCU2C af_cmp_6 (.A0(fcount_12), .A1(scuba_vlo), .B0(scuba_vlo), .B1(scuba_vlo), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co5_6), .S0(), .S1(), .COUT(af_d_c));
    ...
    // exemplar begin
    // exemplar attribute pdp_ram_0_0_3 MEM_LPC_FILE aud_fifo_ip.lpc
    // exemplar attribute pdp_ram_0_0_3 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_1_2 MEM_LPC_FILE aud_fifo_ip.lpc
    // exemplar attribute pdp_ram_0_1_2 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_2_1 MEM_LPC_FILE aud_fifo_ip.lpc
    // exemplar attribute pdp_ram_0_2_1 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_3_0 MEM_LPC_FILE aud_fifo_ip.lpc
